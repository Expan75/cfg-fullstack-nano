...
# def triple1(num): return num * 3
# triple2 = lambda num: num * 3
#
# assert triple1(3) == triple2(3), 'lambda impl. should be equivalent'
# print("triple1: ", triple1(3))
# print("triple1: ", triple2(3))
...
# print(new_list_B)
#
# new_list_looped = [n + 5 for n in my_list if n + 5 < 13]
...
# new_numbers_C = [n for n in numbers if greater_than_five(n)]
#
# print(new_numbers_A)
# print(new_numbers_B)
# print(new_numbers_C)
...
# result_A = reduce(lambda accumulator, current_value: accumulator + current_value, numbers)
...
#
# # sum of squares
# sum_of_squares1 = reduce(lambda a, b: a + b**2, numbers)
#
# # Contrast with list comp; why rely on reduce?
# sum_of_squares2 = sum([n**2 for n in numbers])
#
# print(sum_of_squares1, sum_of_squares2)
...
#
# def fix_student_age(student):
#     """Fixes data age validation issue ..."""
#     student.update({'age': student['age'] + 5})
#     return student
#
#
# def fix_2(x): return x
# def fix_3(x): return x
# def fix_4(x): return x
#
# result1 = list(
#     filter(lambda normalised_student: normalised_student['name'] == 'Priya',
#         list(
#             map(fix_student_age,
#                 map(fix_2, students)
#         )))
...
#
#
# dirty_text = '''asad jas ldkja" "!(!)"( )'''.replace
#
#
#
# #
...
# """
#
my_str = "Nano Degree is fun, Nano Deg"
regex = "Nano\s\w+\s"
...
#
# In general, we can use the compiled approach if we are going to use the pattern MULTIPLE times; otherwise, it’s simpler to use the module-level
# (non-compiled) functions.
# """
#
# my_str = "Software and data science 777 are fun. I especially like doing data analysis and processing."
#
# regex = "data\s(\w+)\s"
